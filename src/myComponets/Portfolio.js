...
export default function Portfolio() {
  ...
  <div className='card-body bg-dark text-light'>
    <p className='card-text'>
      ...
      showcasing services with a modern design. Integrated with Firebase to capture user messages from the contact form for seamless communication.
    </p>
    <div className='d-flex justify-content-between align-items-center'>
      <div className='btn-group'>
        <Link
          to='https://www.siredbits.com/'
          target='_blank'
        >
          <button
            type='button'
